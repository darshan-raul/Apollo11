...
k8s_yaml(['stages/stage-5/dashboard/app/dashboard-configmap.yaml','stages/stage-5/dashboard/app/dashboard-secret.yaml','stages/stage-5/dashboard/app/dashboard-service.yaml','stages/stage-5/dashboard/app/dashboard-deployment.yaml'])
k8s_yaml(['stages/stage-5/booking/app/booking-configmap.yaml','stages/stage-5/booking/app/booking-secret.yaml','stages/stage-5/booking/app/booking-service.yaml','stages/stage-5/booking/app/booking-deployment.yaml','stages/stage-5/booking/db/booking-db-data-persistentvolumeclaim.yaml', 'stages/stage-5/booking/db/booking-db-secret.yaml','stages/stage-5/booking/db/booking-db-service.yaml','stages/stage-5/booking/db/booking-db-statefulset.yaml'])
k8s_yaml(['stages/stage-5/pushmetric/pushmetric-configmap.yaml','stages/stage-5/pushmetric/pushmetric-cronjob.yaml'])
